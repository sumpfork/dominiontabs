...
- Any entries that are not present (either the whole card, or any of `name`/`description`/`extra`) will be assumed to be untranslated and the language compilation tool will insert the English-US version for them.
